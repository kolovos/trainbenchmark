...
public class DgraphRouteSensorMatch extends DgraphMatch implements RouteSensorMatch {
	...
	public DgraphRouteSensorMatch(final Vertex route, final Vertex sensor, final Vertex swP, final Vertex sw) {
		super();
		this.route = route;
		this.sensor = sensor;
		this.swP = swP;
