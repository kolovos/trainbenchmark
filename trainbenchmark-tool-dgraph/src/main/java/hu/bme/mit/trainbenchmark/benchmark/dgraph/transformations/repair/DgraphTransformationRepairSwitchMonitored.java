...
public class DgraphTransformationRepairSwitchMonitored<TDgraphDriver extends DgraphDriver>
		extends DgraphTransformation<DgraphSwitchMonitoredMatch, TDgraphDriver> {

	public DgraphTransformationRepairSwitchMonitored(final TDgraphDriver driver) {
		super(driver);
	}

	@Override
	public void activate(final Collection<DgraphSwitchMonitoredMatch> matches) {
		for (final DgraphSwitchMonitoredMatch ssnm : matches) {
