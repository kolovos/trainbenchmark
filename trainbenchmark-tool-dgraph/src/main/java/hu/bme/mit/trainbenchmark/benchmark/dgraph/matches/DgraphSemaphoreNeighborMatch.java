...
public class DgraphSemaphoreNeighborMatch extends DgraphMatch implements SemaphoreNeighborMatch {
	...
	public DgraphSemaphoreNeighborMatch(final Vertex semaphore, final Vertex route1, final Vertex route2, final Vertex sensor1, final Vertex sensor2,
