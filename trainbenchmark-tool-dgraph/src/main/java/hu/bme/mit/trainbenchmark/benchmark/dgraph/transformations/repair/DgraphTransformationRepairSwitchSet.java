...
public class DgraphTransformationRepairSwitchSet<TDgraphDriver extends DgraphDriver>
		extends DgraphTransformation<DgraphSwitchSetMatch, TDgraphDriver> {

	public DgraphTransformationRepairSwitchSet(final TDgraphDriver driver) {
		super(driver);
	}

	@Override
	public void activate(final Collection<DgraphSwitchSetMatch> matches) {
		for (final DgraphSwitchSetMatch sstm : matches) {
