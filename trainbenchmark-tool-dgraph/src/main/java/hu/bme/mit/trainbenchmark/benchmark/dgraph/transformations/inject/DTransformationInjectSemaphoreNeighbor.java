...
public class DTransformationInjectSemaphoreNeighbor<TDgraphDriver extends DgraphDriver>
		extends DgraphTransformation<DgraphSemaphoreNeighborInjectMatch, TDgraphDriver> {

	public DTransformationInjectSemaphoreNeighbor(final TDgraphDriver driver) {
		super(driver);
	}

	@Override
	public void activate(final Collection<DgraphSemaphoreNeighborInjectMatch> matches) {
		for (final DgraphSemaphoreNeighborInjectMatch match : matches) {
