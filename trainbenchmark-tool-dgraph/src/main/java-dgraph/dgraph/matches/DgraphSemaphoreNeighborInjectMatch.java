...
public class DgraphSemaphoreNeighborInjectMatch extends DgraphMatch implements SemaphoreNeighborInjectMatch {

	protected final Vertex route;
	protected final Vertex semaphore;

	public DgraphSemaphoreNeighborInjectMatch(final Vertex route, final Vertex semaphore) {
		super();
		this.route = route;
