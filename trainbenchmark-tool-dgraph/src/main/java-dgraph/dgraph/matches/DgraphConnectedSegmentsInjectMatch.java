...
public class DgraphConnectedSegmentsInjectMatch extends DgraphMatch implements ConnectedSegmentsInjectMatch {

	protected final Vertex sensor;
	protected final Vertex segment1;
	protected final Vertex segment3;

	public DgraphConnectedSegmentsInjectMatch(final Vertex sensor, final Vertex segment1, final Vertex segment3) {
		super();
		this.sensor = sensor;
