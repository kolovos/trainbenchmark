...
public class DgraphSwitchSetMatch extends DgraphMatch implements SwitchSetMatch {
	...
	public DgraphSwitchSetMatch(final Vertex semaphore, final Vertex route, final Vertex swP, final Vertex sw, final String position,
